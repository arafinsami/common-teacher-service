...
@Data
@NoArgsConstructor
public class EmployeeMpoApplicationEncloserAudit {
    ...
    public static EmployeeMpoApplicationEncloserAudit audit(EmployeeMpoApplicationEncloser encloser) {
        EmployeeMpoApplicationEncloserAudit audit = new EmployeeMpoApplicationEncloserAudit();
