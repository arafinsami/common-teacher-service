...
@Table(name = "EMPLOYEE_RETIREMENT_PAYMENT_ENCLOSER")
public class EmployeeRetirementPaymentEncloser extends BaseEntity {

    private static final Long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "EMPLOYEE_RETIREMENT_PAYMENT_ENCLOSER_ID")
    private Long id;
  ...
  @JoinColumn(name = "EMPLOYEE_RETIREMENT_PAYMENT_ID")
  List<EmployeeRetirementPaymentBreakdown> employeeRetirementPaymentBreakdown;*/
