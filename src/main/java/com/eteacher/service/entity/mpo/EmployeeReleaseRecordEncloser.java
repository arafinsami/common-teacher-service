...
@Table(name = "EMPLOYEE_RELEASE_RECORD_ENCLOSER")
public class EmployeeReleaseRecordEncloser extends BaseEntity {

    private static final Long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "EMPLOYEE_RELEASE_RECORD_ENCLOSER_ID")
    private Long id;
    ...
    @JoinColumn(name = "EMPLOYEE_RELEASE_RECORD_ID")
    private EmployeeReleaseRecord releaseRecord;
}
