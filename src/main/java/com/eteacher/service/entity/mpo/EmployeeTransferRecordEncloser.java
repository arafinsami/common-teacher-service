...
@Table(name = "EMPLOYEE_TRANSFER_RECORD_ENCLOSER")
public class EmployeeTransferRecordEncloser extends BaseEntity {

    private static final Long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "EMPLOYEE_TRANSFER_RECORD_ENCLOSER_ID")
    private Long id;
    ...
    @Column(name = "ENCLOSER_TYPE", length = 10)
 ...
 /* @OneToMany(
  ...
  @JoinColumn(name = "EMPLOYEE_TRANSFER_RECORD_ID")
  List<EmployeeTransferRecordPreferredInstitute> employeeTransferRecordPreferredInstitute;
  ...
  @JoinColumn(name = "EMPLOYEE_TRANSFER_RECORD_ID")
  List<EmployeeTransferRecordPreferredInstitute> employeeTransferRecordPreferredInstitute1;*/
}
